...
export const Message = (props) => {
    ...
    return <Typography type={type} align={align ?align: "center"} noWrap={message.length> 70 ? true: false} color={color ? color : "inherit"} className="element-flex">{message}</Typography>
}
Message.propTypes = {
