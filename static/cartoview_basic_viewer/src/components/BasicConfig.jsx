		...
		this.state = {
			defaultConfig: {
				showZoomControls: this.props.config ?
					this.props.config.showZoomControls : true,
				showNorth: this.props.config ?
					this.props.config.showNorth : true,
				showMousePostion: this.props.config ?
					this.props.config.showMousePostion : true,
				showHome: this.props.config ?
					this.props.config.showHome : true,
				showGeoLocation: this.props.config ?
					this.props.config.showGeoLocation : true,
				show3D: this.props.config ?
					this.props.config.show3D : true,
				showGeoCoding: this.props.config ?
					this.props.config.showGeoCoding : true,
				showLayerSwitcher: this.props.config ?
					this.props.config.showLayerSwitcher : true,
				showBasemapSwitcher: this.props.config ?
					this.props.config.showBasemapSwitcher : true,
